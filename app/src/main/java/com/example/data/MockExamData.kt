...
object MockExamData {
    ...
    val examsHistoryList = mutableStateListOf<MyExamHistoryItem>(
        MyExamHistoryItem("1", "ریاضی دهم", "تابع و معادله درجه دوم", 20, 17, 3, 40, "۱۰ تیر", 85),
        MyExamHistoryItem("2", "فیزیک دهم", "کار، انرژی و توان", 15, 14, 1, 30, "۸ تیر", 92),
        MyExamHistoryItem("3", "شیمی دهم", "کیهان زادگاه الفبای هستی", 25, 15, 10, 45, "۵ تیر", 60),
        MyExamHistoryItem("4", "زیست‌شناسی دهم", "دنیای زنده و سلول", 30, 23, 7, 50, "۲۸ خرداد", 78),
        MyExamHistoryItem("5", "هندسه دهم", "ترسیم‌های هندسی دهم", 15, 7, 8, 35, "۲۰ خرداد", 45),
        MyExamHistoryItem("6", "ادبیات فارسی", "آرایه‌های ادبی و قرابت", 20, 18, 2, 20, "۱۵ خرداد", 90)
    )
